/*
 *  drivers/cpufreq/cpufreq_wrexy.c
 *
...
#define MAX_SAMPLING_DOWN_FACTOR		(15)
...
/* cpufreq_wrexy Governor Tunables */
				   ...
				   unsigned int event)
{
	...
	case CPUFREQ_GOV_START:
		...
		if (dbs_enable == 1) {
			...
			/*
			 * wrexy does not implement micro like ondemand
...
#ifndef CONFIG_CPU_FREQ_DEFAULT_GOV_WREXY
static
#endif
struct cpufreq_governor cpufreq_gov_wrexy = {
	.name			= "wrexy",
...
{
	return cpufreq_register_governor(&cpufreq_gov_wrexy);
}

static void __exit cpufreq_gov_dbs_exit(void)
{
	cpufreq_unregister_governor(&cpufreq_gov_wrexy);
}


MODULE_AUTHOR("Alexander Clouter <alex@digriz.org.uk>");
MODULE_DESCRIPTION("'cpufreq_wrexy' - A dynamic cpufreq governor for "
		"Low Latency Frequency Transition capable processors "
		"optimised for use in a battery environment");
MODULE_LICENSE("GPL");

#ifdef CONFIG_CPU_FREQ_DEFAULT_GOV_WREXY
